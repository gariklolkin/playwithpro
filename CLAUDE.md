...
- Do not invent features outside the active change. Roadmap changes 1–15 (through video annotations) are done; see the roadmap in `openspec/project.md` for the next planned change.
