...
The system SHALL expose a public profile view for a verified coach: display name, avatar, bio, languages, and active services with per-service prices, including the venue label and map position for the in-person game service. Requesting a non-verified or non-existent profile SHALL yield not-found.

#### Scenario: Viewing a verified coach
- **WHEN** a visitor opens a verified coach's public profile
- **THEN** they see the bio, languages, and all active services with prices, with the game service showing its venue
