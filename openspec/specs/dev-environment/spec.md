...
## Purpose
Local development environment and repository conventions: one-command Tilt stack (web, api, PostgreSQL, MinIO, Mailpit, LiveKit), monorepo layout, Prisma migration workflow, CI gates, and environment configuration.
## Requirements
