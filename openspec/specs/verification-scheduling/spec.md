# verification-scheduling Specification

## Purpose
Scheduling machinery for verification calls: admin-published slots, race-safe coach booking with reschedule and withdrawal, Google Meet integration, email confirmations/reminders with .ics, and the meeting state machine.
