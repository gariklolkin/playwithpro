# pro-verification Specification

## Purpose
Identity verification of professionals: one-action submission of the profile itself, a short identity video call scheduled by the coach, and an admin queue that approves or rejects around that call.
