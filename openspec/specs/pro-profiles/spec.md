# pro-profiles Specification

## Purpose
Coach-owned professional profiles: a single "about" block, spoken languages, and up to three priced services (video analysis, consultation, in-person game with a mapped venue). Editable only by the owning professional; admins can read in full.
